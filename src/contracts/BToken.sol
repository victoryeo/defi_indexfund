...
contract BTokenBase is BNum {
    ...
    event B_Approval(address indexed src, address indexed dst, uint amt);
    event B_Transfer(address indexed src, address indexed dst, uint amt);

    function _mint(uint amt) internal {
        _balance[address(this)] = badd(_balance[address(this)], amt);
        _totalSupply = badd(_totalSupply, amt);
        emit B_Transfer(address(0), address(this), amt);
    }
    ...
    function _burn(uint amt) internal {
        ...
        emit B_Transfer(address(this), address(0), amt);
    }
